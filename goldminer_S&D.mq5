...
input color color_support_untested = clrLightGreen;
input color color_support_verified = clrLime;
...
input color color_resist_untested  = clrLightSalmon;
input color color_resist_verified  = C'255,116,116';
input color color_resist_proven    = clrTomato;
